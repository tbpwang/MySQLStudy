...
public class Constant {
    private static final String URL = "jdbc:mysql://10.4.32.21:3306/db_ip?user=root&password=system";//"jdbc:mysql://localhost:3306/db_ip?user=root&password=system";//
    ...
    private static final String INSERT_SQL = "INSERT INTO db_IP.IP(start,end,location,remark)VALUES(INET_ATON(?),INET_ATON(?),?,?)";
